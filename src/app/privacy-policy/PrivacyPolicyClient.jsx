...
/**
 * todo: Privacy Policy Page Component
 * description: Displays the privacy policy information with structured data for SEO
 */
export default function PrivacyPolicy() {
  ...
  const jsonLd = {
    ...
    "@type": "WebPage",
    name: "গোপনীয়তা নীতি | আর্থ্রাইটিস কেয়ার",
    description:
      "আর্থ্রাইটিস কেয়ার ব্যবহারকারীদের তথ্যের সুরক্ষা এবং ব্যবহারের নীতিমালা।",
  };
  ...
  return (
    ...
    >
      ...
      <main className="max-w-[800px] mx-auto px-6 py-16">
        ...
        >
          <h2 id="privacy-policy-title" className="sr-only">
            গোপনীয়তা নীতির বিস্তারিত
          </h2>
          <p>
            আর্থ্রাইটিস কেয়ার - এ, আমরা আপনার গোপনীয়তাকে অত্যন্ত গুরুত্ব
            সহকারে দেখি। এই গোপনীয়তা নীতি বর্ণনা করে যে আমরা কীভাবে আপনার
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            ...
            <li>
              আর্থ্রাইটিস ও বাতরোগ সংক্রান্ত স্বাস্থ্য তথ্য যা আপনি স্বেচ্ছায়
              আমাদের প্রদান করেন।
            </li>
            <li>ব্রাউজিং ডেটা এবং কুকিজ।</li>
          </ul>

          <h2 className="text-2xl font-bold mt-8 mb-4">৩. তথ্যের ব্যবহার</h2>
          <p>আপনার তথ্য আমরা নিম্নলিখিত কাজে ব্যবহার করি:</p>
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li>আর্থ্রাইটিস সম্পর্কিত সেবা প্রদান এবং পরিচালনা করতে।</li>
            <li>
              আপনাকে আর্থ্রাইটিস সম্পর্কিত নিউজলেটার এবং স্বাস্থ্য টিপস পাঠাতে
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">৪. তথ্য সুরক্ষা</h2>
          <p>
            আমরা আপনার ব্যক্তিগত এবং স্বাস্থ্য সংক্রান্ত তথ্যের অননুমোদিত
            অ্যাক্সেস বা প্রকাশ রোধ করতে উপযুক্ত প্রযুক্তিগত এবং সাংগঠনিক
            ব্যবস্থা গ্রহণ করি।
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4">৫. আপনার অধিকার</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4">৬. যোগাযোগ</h2>
          <p>
